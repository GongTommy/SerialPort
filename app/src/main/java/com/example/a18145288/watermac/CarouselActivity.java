...
import com.example.a18145288.watermac.entity.ImageInfo;
import com.example.a18145288.watermac.view.ImageCarousel;
...
/**
 * Created by 18145288 on 2019/6/17.
 */
...
//                R.id.pager_image5, R.id.pager_image6, R.id.pager_image7, R.id.pager_image8};
        ...
        for (int i = 0; i < imageInfoList.size(); i++) {
            ...
            GenericDraweeHierarchy hierarchy = new GenericDraweeHierarchyBuilder(this.getResources())
                    .setPlaceholderImage(ContextCompat.getDrawable(this, R.mipmap.default_pic), ScalingUtils.ScaleType.CENTER_CROP).build();
...
//            simpleDraweeView.setId(imgaeIds[i]);//给view设置id
            simpleDraweeView.setId(i);//给view设置id
